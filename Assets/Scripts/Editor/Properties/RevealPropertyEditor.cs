...
[CustomPropertyDrawer(typeof(RevealPropertyAttribute))]
sealed class RevealProperty : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        RevealPropertyAttribute attribute = (RevealPropertyAttribute)base.attribute;
